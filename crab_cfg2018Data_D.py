...
config.General.requestName = 'SingleMuon_Run2018UL_D'
...
config.Data.inputDataset = '/SingleMuon/Run2018D-UL2018_MiniAODv1_NanoAODv2-v2/NANOAOD'
...
config.Data.outputDatasetTag = 'SingleMuon_Run2018UL_D'
