...
config.General.requestName = 'SingleMuon_Run2018UL_C'
...
config.Data.inputDataset = '/SingleMuon/Run2018C-UL2018_MiniAODv1_NanoAODv2-v2/NANOAOD'
...
config.Data.outputDatasetTag = 'SingleMuon_Run2018UL_C'
