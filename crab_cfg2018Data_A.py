...
config.General.requestName = 'SingleMuon_Run2018UL_A'
...
config.Data.inputDataset = '/SingleMuon/Run2018A-UL2018_MiniAODv1_NanoAODv2-v3/NANOAOD'
...
config.Data.outputDatasetTag = 'SingleMuon_Run2018UL_A'
