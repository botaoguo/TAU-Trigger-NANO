...
for input_id in range(n_inputs):
    fileprefix = os.path.basename(input_files[int(input_id/2)])
    ...
    turnOn_data[input_id] = CreateHistograms(input_files[int(input_id/2)], channels, decay_modes, 'leading_tau_idDeepTauVSjet', # tau_idDeepTau2017v2p1VSjet,
    ...
    for wp in working_points:
        for dm in decay_modes:
            ...
            for input_id in range(n_inputs):
                ...
                RootPlotting.ApplyDefaultLineStyleMarker(curve, colors[input_id], marker[int(input_id/2)])
                ...
                if input_id < n_inputs - 1:
                    ...
                    if ratio_graph[input_id]:
                        ...
                        RootPlotting.ApplyDefaultLineStyleMarker(ratio_graph[input_id], ratio_color, marker[int(input_id/2)])
